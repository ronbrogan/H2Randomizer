...
namespace H2Randomizer
{
    ...
    public class LevelData
    {
        ...
        {
            ["brute"] = new[] { "battle_rifle", "brute_plasma_rifle", "brute_shot", "covenant_carbine", "plasma_rifle", "sent_agg_beam_elim", "sentinel_aggressor_beam", "shotgun", "smg", "sniper_rifle" },
            ["brute_captain"] = new[] { "battle_rifle", "brute_plasma_rifle", "brute_shot", "covenant_carbine", "plasma_rifle", "shotgun", "smg", "sniper_rifle" },
            ["brute_honor_guard"] = new[] { "battle_rifle", "brute_plasma_rifle", "brute_shot", "covenant_carbine", "plasma_rifle", "shotgun", "smg", "sniper_rifle" },
            ["brute_major"] = new[] { "battle_rifle", "brute_plasma_rifle", "brute_shot", "covenant_carbine", "plasma_rifle", "shotgun", "smg", "sniper_rifle" },
            ...
            ["flood_combat_human"] = new[] { "battle_rifle", "brute_plasma_rifle", "covenant_carbine", "energy_blade", "magnum", "needler", "plasma_pistol", "plasma_rifle", "shotgun", "smg", "sniper_rifle" },
            ["flood_juggernaut"] = Array.Empty<string>(),
            ["floodcombat_elite"] = new[] { "battle_rifle", "brute_plasma_rifle", "covenant_carbine", "energy_blade", "magnum", "needler", "plasma_pistol", "plasma_rifle", "shotgun", "smg", "sniper_rifle" },
            ["floodcombat_elite_shielded"] = new[] { "battle_rifle", "brute_plasma_rifle", "covenant_carbine", "energy_blade", "magnum", "needler", "plasma_pistol", "plasma_rifle", "shotgun", "smg", "sniper_rifle" },
            ...
            ["heretic_major"] = new[] { "beam_rifle", "covenant_carbine", "energy_blade", "flak_cannon", "needler", "plasma_pistol", "plasma_rifle", "sentinel_aggressor_beam" },
